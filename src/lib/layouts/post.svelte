          ...
          {#if nextPost}
            <div id="next-post" class="relative flex-1 group overflow-hidden bg-white/[0.5] dark:bg-black/[0.5]">
              ...
              <a
                rel="next"
                href="/{nextPost.slug}"
                class="absolute text-2xl font-bold z-10 !decoration-none !underline-none title-link-amber-700-amber-900 top-[3rem] left-[1rem] mr8">
                {nextPost.title}
              </a>
              {#if nextPost.cover}
                <ImgBanner
          ...
          {#if prevPost}
            <div id="prev-post" class="relative flex-1 group overflow-hidden bg-white/[0.5] dark:bg-black/[0.5]">
              <a
                rel="prev"
                href="/{prevPost.slug}"
                class="absolute text-2xl font-bold z-10 !decoration-none !underline-none title-link-amber-700-amber-900 top-[3rem] right-[1rem] ml8">
                {prevPost.title}
              </a>
              <div
