...
<Post>
  <article slot="post_content">
    ...
    <p>
      ...
      laughing about it. This is always true. It comes from the freedom to realize things on your own in a segregated enviroment,
      seperated from the actions happening. This gives one self a modified sense of control over the situation because we
      reimagine it differntly. Instead, one can simply understand that they are simulating and that is completly unique from
      the situation however comparable the simulation and reality may be. So in short, imagination is real but it only goes
      one way.
    </p>
    <p>In the end? All this stuff? It&#39;s just a whirlwind of fists. As usual. Don&#39;t get sucked in.</p>
    <p><a href="u1fa84_u1f32a-ufe0f.png">whirlwind</a></p>
